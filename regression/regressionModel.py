...
regression_model_path = '../corpus/regmodel/allLanguages_regression_model_el_averageLanguageStability_bootstrapping_'
...
regression_scores_path = '../corpus/regmodel/allLanguages_regression_model_el_averageLanguageStability_bootstrapping_scores.pkl'
...
for iteration in range(0, 1000): # Bootstrap 1000 iterations
	...
	model = Ridge(alpha=0.1) # regression model, can be changed to Lasso
...
print('Average R2 score',sum(scores)/len(scores))
