...
regression_model_path = '../corpus/wals/cv/crossValidation_elastic_'
...
cross_validation_output_path = '../corpus/wals/cv/crossValidation_elastic_'
...
lang_temp = languages
languages = []
for language in tqdm(lang_temp):
	if language in average_stabilities.language.values:
...
for regularization in [0.0001,0.001,0.01,0.1,1,10,100,1000]:
	...
	print(regularization,sum(errors)/len(errors))
